...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\item \redtext{Calculate energy generation ($\epsilon_{{\rm nuc},i}$)
  through nuclear reaction. When the reaction is exothermic, the
  density ($\rho_i$) and temperature ($\tilde{T}_i$) are fixed. On the
  other hand, when the reaction is endothermic, only the density
  ($\rho_i$) is fixed.}
