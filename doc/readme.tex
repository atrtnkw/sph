...
\begin{figure}
  ...
  \end{center}
  \caption{Single COWD equilibrium ($1k/0.1M_{\odot}$ w/o new
    damping.}
\end{figure}

\begin{figure}
  \begin{center}
    \includegraphics[width=14cm,bb=0 0 880 840]{fig/wddamp/draw.png}
  \end{center}
  \caption{Density and temperature of $1M_\odot$ COWD
    ($1k/0.1M_{\odot}$. A new damping mode with cooling during 100 s,
    such that $u_{{\rm new},i} = (u_{{\rm old},i} - u_{\rm
      min}(\rho_i)) \exp(-0.1 \Delta t) + u_{\rm min}(\rho_i)$.}
\end{figure}

\begin{figure}
  \begin{center}
    \includegraphics[width=14cm,bb=0 0 880 1240]{fig/bwdrun/draw.png}
  \end{center}
