...
\begin{figure}
  ...
  \end{center}
  \caption{Density and temperature of $1M_\odot$ COWD. A new damping
    mode with cooling during 100 s, such that $u_{{\rm new},i} =
    (u_{{\rm old},i} - u_{\rm min}(\rho_i)) \exp(-0.1 \Delta t) +
    u_{\rm min}(\rho_i)$.}
\end{figure}
