...
echo "/work/tanikwat/git-sph/nswd/data/r008k/run.bns-wd1.0_ecc.tmp/unfy"  > input.list
echo "/work/tanikwat/git-sph/nswd/data/r008k/run.bns-wd1.0_ecc.tmp/anim/xy" >> input.list
